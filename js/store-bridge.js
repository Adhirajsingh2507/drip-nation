...
const StoreBridge = {
    ...
    ensureDefaults: function () {
        ...
        if (!localStorage.getItem(this.KEYS.products)) {
            ...
            const jerseyImgs = ['assets/images/i3 (1).jpeg', 'assets/images/i3 (2).jpeg', 'assets/images/i4.jpeg', 'assets/images/i5.jpeg'];
            const accImgs = ['assets/images/accessories.jpeg', 'assets/images/i6.jpeg', 'assets/images/WhatsApp Image 2026-07-06 at 15.58.23.jpeg', 'assets/images/second page image.jpeg'];
            const jacketImgs = ['assets/images/jackets.jpeg', 'assets/images/i4.jpeg', 'assets/images/i5.jpeg', 'assets/images/i3 (1).jpeg'];
            const trackImgs = ['assets/images/track and suit.jpeg', 'assets/images/i3 (2).jpeg', 'assets/images/i4.jpeg', 'assets/images/i5.jpeg'];

            let id = 100;
            function addBatch(names, category, images, priceMin, priceMax) {
                names.forEach((name, i) => {
                    ...
                    defaultProducts.push({
                        ...
                        image: images[i % images.length], desc: ''
                    });
                });
            }

            addBatch(jerseyNames, 'Retro Jersey', jerseyImgs, 1499, 3499);
            addBatch(accNames, 'Accessories', accImgs, 299, 2499);
            addBatch(jacketNames, 'Jackets', jacketImgs, 1999, 5999);
            addBatch(trackNames, 'Track & Suit', trackImgs, 1299, 4999);
    ...
    renderProductCard: function (product) {
        ...
        return `
            <div class="dn-product-card" onclick="window.location.href='product.html?id=${product.id}'">
                <div class="dn-product-card-image" style="background-image: url('${product.image}');"></div>
                ...
                <div class="dn-product-card-actions">
                    <button class="dn-add-cart-btn" onclick="event.stopPropagation(); CartEngine.addItem('${safeName}', '${cartPrice}', '${product.image}')">+ ADD</button>
                </div>
            </div>
        `;
    }
